...
public class SampleController {
	...
	public Mono<String> sample1() {
		...
		Mono<String> ms1 = webClient.get().uri("http://sample-service2-v2.charles3.svc.cluster.local").retrieve().bodyToMono(String.class);
		Mono<String> ms2 = webClient.get().uri("http://sample-service3-v1.charles3.svc.cluster.local").retrieve().bodyToMono(String.class);
